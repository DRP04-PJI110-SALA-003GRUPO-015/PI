                ...
                <tbody>
                    ...
                    try {
                        ...
                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                            ...
                            echo "<td>";
                            echo "<button class='btn btn-primary btn-sm mr-2' onclick='editarRegistro(" . $row['dbpi1_tbcliente_id'] . ")'>Atualizar</button>";
                            echo "<button class='btn btn-danger btn-sm' onclick='excluirRegistro(" . $row['dbpi1_tbcliente_id'] . ")'>Excluir</button>";
                            echo "</td>";
                            echo "</tr>";
                        }
