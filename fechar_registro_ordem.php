...
if(isset($_GET["id"])) {
    ...
    try {
        ...
        $sql = "UPDATE dbpi1_tbordem SET dbpi1_tbordem_status='Fechada', dbpi1_tbordem_datafechamento='$datadehoje' WHERE dbpi1_tbordem_id = :id AND dbpi1_tbordem_status='Aberta'";
