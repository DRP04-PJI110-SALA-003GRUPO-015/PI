...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO dbpi1_tbcliente (dbpi1_tbcliente_cpfcnpj, dbpi1_tbcliente_nomerazao, dbpi1_tbcliente_endereco, dbpi1_tbcliente_telefone, dbpi1_tbcliente_email) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $cpfcnpj, $nomerazao, $endereco, $telefone, $email);
...
<body>
    <div class="container mt-4">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
                <label for="nomerazao">Nome ou Razão Social:</label>
            ...
            <div class="form-group d-flex justify-content-between">
                ...
                <input type="button" class="btn btn-secondary" value="Cancelar" onclick="window.location.href='menu_clientes.php'">
            </div>
        </form>
    </div>
